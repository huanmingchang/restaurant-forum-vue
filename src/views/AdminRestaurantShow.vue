...
export default {
  ...
  methods: {
    fetchRestaurant(restaurantId) {
      ...
      this.restaurant.image = dummyData.restaurant.image
      this.restaurant.openingHours = dummyData.restaurant.opening_hours
      this.restaurant.tel = dummyData.restaurant.tel
      this.restaurant.address = dummyData.restaurant.address
      this.restaurant.description = dummyData.restaurant.description
    },
  },
  mounted() {
